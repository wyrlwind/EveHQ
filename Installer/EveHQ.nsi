...
SectionIn RO
  ...
  File "..\BuildOutput\EveHQ\Release\DevComponents.DotNetBar2.dll"
  File "..\BuildOutput\EveHQ\Release\EveCacheParser.dll"
  ...
  File "..\BuildOutput\EveHQ\Release\EveHQ.EveData.pdb"
  File "..\BuildOutput\EveHQ\Release\EveHQ.exe"
  File "..\BuildOutput\EveHQ\Release\EveHQ.pdb"
  File "..\BuildOutput\EveHQ\Release\EveHQ.exe.config"
  File "..\BuildOutput\EveHQ\Release\EveHQ.HQF.dll"
  File "..\BuildOutput\EveHQ\Release\EveHQ.HQF.pdb"
  File "..\BuildOutput\EveHQ\Release\EveHQ.KillMailViewer.dll"
  File "..\BuildOutput\EveHQ\Release\EveHQ.KillMailViewer.pdb"
  File "..\BuildOutput\EveHQ\Release\EveHQ.Market.dll"
  File "..\BuildOutput\EveHQ\Release\EveHQ.Market.pdb"  
  File "..\BuildOutput\EveHQ\Release\EveHQ.NewEveAPI.dll"
  File "..\BuildOutput\EveHQ\Release\EveHQ.NewEveAPI.pdb"
  File "..\BuildOutput\EveHQ\Release\EveHQ.Prism.dll"
  File "..\BuildOutput\EveHQ\Release\EveHQ.Prism.pdb"
  File "..\BuildOutput\EveHQ\Release\EveHQ.EveCrest.dll"
  File "..\BuildOutput\EveHQ\Release\EveHQ.EveCrest.pdb"
  File "..\BuildOutput\EveHQ\Release\EveHQ.Void.dll"
  File "..\BuildOutput\EveHQ\Release\EveHQ.Void.pdb"
  File "..\BuildOutput\EveHQ\Release\GammaJul.lglcd.dll"
  File "..\BuildOutput\EveHQ\Release\GammaJul.lglcd.Native32.dll"
  File "..\BuildOutput\EveHQ\Release\GammaJul.lglcd.Native64.dll"
  File "..\BuildOutput\EveHQ\Release\Ionic.Zip.dll"
  File "..\BuildOutput\EveHQ\Release\Newtonsoft.json.dll"
  File "..\BuildOutput\EveHQ\Release\protobuf-net.dll"
  ...
  File "..\BuildOutput\EveHQ\Release\x64\SQLite.Interop.dll"
  SetOutPath $INSTDIR\x86
  File "..\BuildOutput\EveHQ\Release\x86\SQLite.Interop.dll"
...
###################################################################
  ...
  SetOutPath $INSTDIR\StaticData
	...
	File "..\BuildOutput\EveHQ\Release\StaticData\Agents.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\AssemblyArrays.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\attributes.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\AttributeTypes.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\Blueprints.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\boosters.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\CertCats.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\CertRec.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\Certs.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\CertSkills.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\Constellations.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\Divisions.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\EffectTypes.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\GroupCats.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\implants.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\ItemCats.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\ItemFlags.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\ItemGroups.bin"
	File "..\BuildOutput\EveHQ\Release\StaticData\ItemGroups.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\ItemList.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\ItemMarketGroups.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\Items.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\ItemUnlocks.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\MarketGroups.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\Masteries.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\MetaGroups.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\MetaTypes.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\modules.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\NPCCorps.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\Regions.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\ShipGroups.bin"
	File "..\BuildOutput\EveHQ\Release\StaticData\ships.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\skills.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\SkillUnlocks.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\Stations.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\Systems.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\Traits.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\TypeAttributes.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\TypeEffects.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\TypeMaterials.dat"
	File "..\BuildOutput\EveHQ\Release\StaticData\Units.dat"
